...
DumbSlave dumb = new DumbSlave("myagent",  // Agent name, usually matches the host computer's machine name
                               "hahha",           // Agent description
                               "/opt/jenkins",                  // Workspace on the agent's computer
